...
/** App Shell 视图路由：四大主视图 + Token + 设计 + 知识库 + 工作区（多 Tab 工作台） */
export type ActiveView = 'dashboard' | 'simulation' | 'coverage' | 'regression' | 'token' | 'design' | 'kb' | 'workspace';
...
const ACTIVE_VIEWS: readonly ActiveView[] = ['dashboard', 'simulation', 'coverage', 'regression', 'token', 'design', 'kb', 'workspace'];
