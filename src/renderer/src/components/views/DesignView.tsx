...
function ConfigPanel({
  ...
  const [directory, setDirectory] = useState(() => ({
    ...
    excludes: initial.directory?.excludes ?? ['**/dv/**', '**/dv_sv/**', '**/generic_dv/**', '**/test/**', '**/tests/**', '**/tb/**', '**/vendor/**', '**/verilator/**', '**/autogen/**'],
