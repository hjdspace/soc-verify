...
import { Plus, Send, Square, MessageSquare, Trash2, ChevronDown, Loader2, Clock, Pencil, X, Check, Paperclip, Cpu, Compass, Search, FileText, Folder, Sparkles, FolderOpen } from 'lucide-react';
import { useSessionStore, type ChatMessage, type AvailableModel, type SelectedSkill, type ContextFile } from '@renderer/stores/session';
